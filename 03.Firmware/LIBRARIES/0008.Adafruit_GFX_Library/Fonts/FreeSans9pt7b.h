...
const GFXglyph FreeSans9pt7bGlyphs[] PROGMEM = {
    ...
    {7, 10, 12, 10, 0, 0},    // 0x23 '#'
    {22, 9, 16, 10, 1, 0},    // 0x24 '$'
    {40, 16, 13, 16, 1, 0},   // 0x25 '%'
    {66, 11, 13, 12, 1, 0},   // 0x26 '&'
    {84, 2, 4, 4, 1, 0},      // 0x27 '''
    {85, 4, 17, 6, 1, 0},     // 0x28 '('
    {94, 4, 17, 6, 1, 0},     // 0x29 ')'
    {103, 5, 5, 7, 1, 0},     // 0x2A '*'
    ...
    {115, 2, 1, 5, 1, 0},     // 0x2E '.'
    {116, 5, 13, 5, 0, 0},    // 0x2F '/'
    {125, 8, 13, 10, 1, 0},   // 0x30 '0'
    {138, 4, 13, 10, 3, 0},   // 0x31 '1'
    {145, 9, 13, 10, 1, 0},   // 0x32 '2'
    {160, 8, 13, 10, 1, 0},   // 0x33 '3'
    {173, 7, 13, 10, 2, 0},   // 0x34 '4'
    {185, 9, 13, 10, 1, 0},   // 0x35 '5'
    {200, 9, 13, 10, 1, 0},   // 0x36 '6'
    {215, 8, 13, 10, 0, 0},   // 0x37 '7'
    {228, 9, 13, 10, 1, 0},   // 0x38 '8'
    {243, 8, 13, 10, 1, 0},   // 0x39 '9'
    {256, 2, 10, 5, 1, 0},    // 0x3A ':'
    {259, 3, 12, 5, 1, 0},    // 0x3B ';'
    {264, 9, 9, 11, 1, 0},    // 0x3C '<'
    {275, 9, 4, 11, 1, 0},    // 0x3D '='
    {280, 9, 9, 11, 1, 0},    // 0x3E '>'
    {291, 9, 13, 10, 1, 0},   // 0x3F '?'
    {306, 17, 16, 18, 1, 0},  // 0x40 '@'
    {340, 12, 13, 12, 0, 0},  // 0x41 'A'
    {360, 11, 13, 12, 1, 0},  // 0x42 'B'
    {378, 11, 13, 13, 1, -0}, // 0x43 'C'
    {396, 11, 13, 13, 1, -0}, // 0x44 'D'
    {414, 9, 13, 11, 1, -0},  // 0x45 'E'
    {429, 8, 13, 11, 1, -0},  // 0x46 'F'
    {442, 12, 13, 14, 1, -0}, // 0x47 'G'
    {462, 11, 13, 13, 1, -0}, // 0x48 'H'
    {480, 2, 13, 5, 2, -0},   // 0x49 'I'
    {484, 7, 13, 10, 1, -0},  // 0x4A 'J'
    {496, 11, 13, 12, 1, -0}, // 0x4B 'K'
    {514, 8, 13, 10, 1, 0},   // 0x4C 'L'
    {527, 13, 13, 15, 1, 0},  // 0x4D 'M'
    {549, 11, 13, 13, 1, 0},  // 0x4E 'N'
    {567, 13, 13, 14, 1, 0},  // 0x4F 'O'
    {589, 10, 13, 12, 1, 0},  // 0x50 'P'
    {606, 13, 14, 14, 1, 0},  // 0x51 'Q'
    {629, 12, 13, 13, 1, 0},  // 0x52 'R'
    {649, 10, 13, 12, 1, 0},  // 0x53 'S'
    {666, 9, 13, 11, 1, 0},   // 0x54 'T'
    {681, 11, 13, 13, 1, 0},  // 0x55 'U'
    {699, 11, 13, 12, 0, 0},  // 0x56 'V'
    {717, 17, 13, 17, 0, 0},  // 0x57 'W'
    {745, 12, 13, 12, 0, 0},  // 0x58 'X'
    {765, 12, 13, 12, 0, 0},  // 0x59 'Y'
    {785, 10, 13, 11, 1, 0},  // 0x5A 'Z'
    {802, 3, 17, 5, 1, 0},    // 0x5B '['
    {809, 5, 13, 5, 0, 0},    // 0x5C '\'
    {818, 3, 17, 5, 0, 0},    // 0x5D ']'
    {825, 7, 7, 8, 1, 0},     // 0x5E '^'
    ...
    {834, 4, 3, 5, 0, 0},     // 0x60 '`'
    {836, 9, 10, 10, 1, 0},   // 0x61 'a'
    {848, 9, 13, 10, 1, 0},   // 0x62 'b'
    {863, 8, 10, 9, 1, 0},    // 0x63 'c'
    {873, 8, 13, 10, 1, 0},   // 0x64 'd'
    {886, 8, 10, 10, 1, 0},   // 0x65 'e'
    {896, 4, 13, 5, 1, 0},    // 0x66 'f'
    {903, 8, 14, 10, 1, 0},   // 0x67 'g'
    {917, 8, 13, 10, 1, 0},   // 0x68 'h'
    {930, 2, 13, 4, 1, 0},    // 0x69 'i'
    {934, 4, 17, 4, 0, 0},    // 0x6A 'j'
    {943, 9, 13, 9, 1, 0},    // 0x6B 'k'
    {958, 2, 13, 4, 1, 0},    // 0x6C 'l'
    {962, 13, 10, 15, 1, 0},  // 0x6D 'm'
    {979, 8, 10, 10, 1, 0},   // 0x6E 'n'
    {989, 8, 10, 10, 1, 0},   // 0x6F 'o'
    {999, 9, 13, 10, 1, 0},   // 0x70 'p'
    {1014, 8, 13, 10, 1, 0},  // 0x71 'q'
    {1027, 5, 10, 6, 1, 0},   // 0x72 'r'
    {1034, 8, 10, 9, 1, 0},   // 0x73 's'
    {1044, 4, 12, 5, 1, 0},   // 0x74 't'
    {1050, 8, 10, 10, 1, 0},  // 0x75 'u'
    {1060, 9, 10, 9, 0, 0},   // 0x76 'v'
    {1072, 13, 10, 13, 0, 0}, // 0x77 'w'
    {1089, 8, 10, 9, 0, 0},   // 0x78 'x'
    {1099, 9, 14, 9, 0, 0},   // 0x79 'y'
    {1115, 7, 10, 9, 1, 0},   // 0x7A 'z'
    {1124, 4, 17, 6, 1, 0},   // 0x7B '{'
    {1133, 2, 17, 4, 2, 0},   // 0x7C '|'
    {1138, 4, 17, 6, 1, 0},   // 0x7D '}'
    {1147, 7, 3, 9, 1, 0}};   // 0x7E '~'
